globals [
  ...
  initial-water		;; how many water turtles
]

breed [fires fire]    ;; bright red turtles -- the leading edge of the fire
breed [embers ember]  ;; turtles gradually fading from red to near black
breed [waters water]	;; blue turtles -- the water spawned
breed [soils soil]		;;brown turtles
...
;; brown color for the ground as water goes across
to put-out
  ask soils
  	[set pcolor brown die]
end
